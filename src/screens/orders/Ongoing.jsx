                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={{ borderRadius: wp(5), backgroundColor: '#1f222a', overflow: 'hidden', marginBottom: hp(2.5) }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: wp(1.5), marginTop: hp(0.5), paddingVertical: hp(2), borderTopColor: '#303135', borderTopWidth: wp(0.4) }}>
                                <View style={{ width: wp(40), paddingVertical: hp(1), borderWidth: wp(0.5), borderColor: '#fff', borderRadius: wp(10) }}>
                                    <Text style={{ fontFamily: 'Urbanist-SemiBold', color: '#e2e2e3', fontSize: hp(2.2), textAlign: 'center' }}>Cancel Order</Text>
                                </View>
                                <View style={{ width: wp(40), paddingVertical: hp(1.2), borderRadius: wp(10), backgroundColor: '#35383f' }}>
                                    <Text style={{ fontFamily: 'Urbanist-SemiBold', color: '#e2e2e3', fontSize: hp(2.2), textAlign: 'center' }}>Track Order</Text>
                                </View>
                            </View>
                        </View>
                    )}
